...
impl TribeScen {
    ...
    pub fn legacy_ai_filenames(&self) -> &[Option<String>] {
        &self.base.player_ai_rules
    }

    pub fn legacy_ai_script_contents(&self) -> Vec<Option<&str>> {
        self.base
            .player_files
            .iter()
            .take(16)
            .map(|f| f.ai_rules.as_deref())
            .collect()
    }

    pub fn legacy_ai_rules_types(&self) -> &[i8] {
        &self.base.ai_rules_types
    }
}
