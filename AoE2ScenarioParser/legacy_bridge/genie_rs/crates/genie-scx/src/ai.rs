...
use genie_support::{write_i32_str, ReadStringError, ReadStringsExt};
...
impl AIErrorInfo {
    ...
    pub fn read_from(mut input: impl Read) -> Result<Self> {
        ...
        // AoK-era scenarios may carry values outside the documented enum (misalignment or engine quirks).
        let raw_code = input.read_u32::<LE>()?;
        let error_code = raw_code
            .try_into()
            .unwrap_or(AIErrorCode::UndocumentedError);
