...
"""
Parse scenario files under a corpus directory with ``aoe2_mcgeniescx`` and write ``parser_report.txt``.
...
def _write_report(
    ...
    *,
    ...
    lines: list[str] = [
        "aoe2_mcgeniescx parser validation report",
        "====================================",
...
def main() -> int:
    ...
    ap = argparse.ArgumentParser(
        description="Parse scenarios with aoe2_mcgeniescx and write a report (default: every file under --root)."
    )
    ap.add_argument(
        "--root",
        type=Path,
